...
namespace SignNowBackend.Controllers
{
    ...
    public class OrchestratorController : BaseApiController
    {
        ...
        public async Task<IActionResult> EmbedSend(
            [FromForm] IFormFile file,
            [FromForm] string workflow,
            [FromForm] string user_id,   // 👈 added here
            CancellationToken ct)
        {
            ...
            // 👇 validate the form-sent user_id
            if (string.IsNullOrWhiteSpace(user_id))
                return Problem("user_id is required in the form.", statusCode: 400);
            ...
            // Report to Node (DB write happens there)
